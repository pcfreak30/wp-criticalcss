...
class Request extends Component {
	 ...
	 *
	 */
	public function record_template( $slug, $name, $templates ) {
		$location = locate_template( $templates, false );

		if ( ! empty( $location ) ) {
			$this->template[] = str_replace( trailingslashit( WP_CONTENT_DIR ), '', $location );
			$this->template   = array_unique( $this->template );
		}
	}
